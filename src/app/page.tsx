  ...
  return (
    <main className="dark">
      ...
      <div className="w-full h-fit bg-white border-t-8 border-b-8 border-[#39fc03]/30 dark:bg-black py-10">
        <div
          id="call"
          className="flex flex-col dark:text-white text-black justify-center items-center "
        >
          <h1 className="text-4xl font-bold px-2 pe-2  mb-10 ">Get In Touch</h1>
          <TextGenerateEffect
            filter={false}
      ...
      <div className="w-full h-fit flex justify-center items-center bg-white dark:bg-black ">
        <h2 className="p-5 dark:text-white text-black">
          © 2025 Ahmed Abdelraheem Barakat . All rights reserved.
        </h2>
      </div>
    </main>
  );
